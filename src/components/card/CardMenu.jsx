...
function CardMenu(props) {
  ...
  return (
    <Dropdown
      button={
        <button
          ...
          className={`flex items-center text-xl hover:cursor-pointer ${transparent
            ...
            : "bg-lightPrimary p-2 text-brand-500 hover:bg-gray-100 dark:bg-teal-700 dark:text-white dark:hover:bg-white/20 dark:active:bg-white/10"
      ...
      children={
        <div className="z-50 w-max rounded-xl bg-white py-3 px-4 text-sm shadow-xl shadow-shadow-500 dark:!bg-teal-700 dark:shadow-none">
