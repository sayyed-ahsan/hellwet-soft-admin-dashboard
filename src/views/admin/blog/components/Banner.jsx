...
const Banner = () => {
    return (
        <Glass>
            <section className="rounded-2xl  bg-primaryLight dark:bg-primaryDark dark:text-gray-100">
                <div className="container flex flex-col mx-auto lg:flex-row">
                    <div className="w-full p-4 lg:w-1/3">
                        <img className='h-full rounded-2xl' src="https://source.unsplash.com/random/640x480" alt="" />
                    </div>
                    <div className="flex flex-col w-full p-6 lg:w-2/3 md:p-8 lg:p-12">
                        ...
                        <button className="self-start px-10 py-3 text-lg font-medium rounded-3xl glass btn">Get started</button>
                    </div>
                </div>
            </section>
        </Glass>
