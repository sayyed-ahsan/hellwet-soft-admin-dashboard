...
const index = () => {
    return (
        <div>
            <Banner></Banner>
            {/* ------ */}
            <div className='grid gap-4 my-5 grid-cols-3'>
                <div className="col-span-1 rounded-2xl shadow-md  dark:bg-primaryDark dark:text-gray-100">
            ...
            <div className="flex justify-center ">
                <button type="button" className="bg-primaryLight mt-4 px-6 py-3 text-sm rounded-md hover:underline dark:bg-primaryDark dark:text-gray-400">Load more posts...</button>
            </div>
        </div>
    );
};
