...
const index = () => {
    return (
        ...
        <Glass>
            <div className='mb-5 rounded-2xl w-full max-w-full  bg-primaryLight dark:bg-primaryDark shadow-default dark:border-strokedark dark:bg-boxdark'>
                <table className='w-full'>
                    <thead>
                        <tr className='grid grid-cols-7 rounded-t-2xl bg-brandLight text-white'>
