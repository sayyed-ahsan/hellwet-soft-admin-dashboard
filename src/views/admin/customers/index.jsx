...
import Img from '../../../assets/img/profile/banner.png'
...
const index = () => {
    return (
        <div>
            {/* -----------Banner----------- */}
            <Card>
                <div className="p-5 mx-auto sm:p-10 md:p-16 bg-primaryLight dark:bg-primaryDark runded-2xl dark:text-darkText">
                    <div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
                        <img src={Img} alt="" className="w-full rounded-[20px] h-60 sm:h-96 dark:bg-gray-500" />
                        <div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md bg-secounderyLight dark:bg-secounderyDark glass">
            ...
            <div className='my-5'>
                <Card>
                    <section className="py-6 rounded-2xl  dark:bg-primaryDark dark:text-gray-50">
                        <div className="container mx-auto flex flex-col justify-center p-4 space-y-8 md:p-10 lg:space-y-0 lg:space-x-12 lg:justify-between lg:flex-row">
                            ...
                            <div className="flex dark:bg-red-400 rounded-md flex-row items-center self-center justify-center flex-shrink-0 shadow-md lg:justify-end">
                                <div className="flex flex-row">
                                    <input type="text" placeholder="example@email.com" className="w-3/5 p-3 rounded-l-lg sm:w-2/3 dark:text-gray-900" />
            ...
            {/* ---------Overview-------- */}
            <div className='mb-5'>
                <section className=" my-6 md:p-8 dark:bg-secounderyDark dark:text-gray-100">
            ...
            {/* -----------Testimonial--------- */}
            <section className="my-8 bg-primaryLight dark:text-darkText dark:bg-primaryDark rounded-2xl ">
                ...
                <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10 pb-5">
