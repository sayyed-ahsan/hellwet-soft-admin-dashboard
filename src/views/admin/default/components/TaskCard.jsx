    ...
    <Card extra="pb-7 p-[20px]">
      ...
      <div className="relative flex flex-row justify-between">
        <div className="flex items-center">
          ...
          <h4 className="ml-4 text-xl font-bold text-teal-700 dark:text-white">
            Tasks
          </h4>
        </div>
        <CardMenu />
      ...
      <div className="h-full w-full">
        <div className="mt-5 flex items-center justify-between p-2">
          <div className="flex items-center justify-center gap-2">
            <Checkbox />
            <p className="text-base font-bold text-teal-700 dark:text-white">
              Landing Page Design
            </p>
          </div>
          <div>
            <MdDragIndicator className="h-6 w-6 text-teal-700 dark:text-white" />
          </div>
        </div>
