...
import profilImg from "../../../../assets/img/avatars/avatar3.png"

const ShereProfile = () => {
    return (
        <div className="flex flex-col justify-center h-full p-6  rounded-2xl sm:px-12 bg-primaryLight dark:bg-primaryDark dark:text-gray-100">
            <img src={profilImg} alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
