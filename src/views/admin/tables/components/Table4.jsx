...
import Img from "../../../../assets/img/profile/image2.png"
const Table4 = () => {
    return (
        <Glass>
            <Card>
                <div
                    className="shadow-default rounded-2xl border border-stroke dark:border-strokedark bg-primaryLight dark:bg-primaryDark dark:bg-boxdark pt-6 pb-2.5 xl:pb-1 px-5 sm:px-7.5">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="grid grid-cols-3 sm:grid-cols-5 border-b border-stroke dark:border-strokedark">
                            <div className="flex items-center gap-3 p-2.5 xl:p-5">
                                <div className="flex-shrink-0"><img src={Img} alt="Brand" /></div>
