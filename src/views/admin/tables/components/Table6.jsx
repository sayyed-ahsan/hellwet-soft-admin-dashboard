...
import Img1 from '../../../../assets/img/avatars/user-01.png'
import Img2 from '../../../../assets/img/avatars/user-02.png'
import Img3 from '../../../../assets/img/avatars/user-03.png'
import Img4 from '../../../../assets/img/avatars/user-04.png'
import Img5 from '../../../../assets/img/avatars/user-05.png'
import Img6 from '../../../../assets/img/avatars/user-06.png'
        ...
        <Glass>
            <div>
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="flex items-center justify-between py-4 bg-primaryLight dark:bg-primaryDark rounded-t-2xl">
                        <div>
                            <button id="dropdownActionButton" data-dropdown-toggle="dropdownAction" class="ml-4 inline-flex items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-secounderyLight focus:ring-4 focus:ring-gray-200 font-medium rounded-2xl text-sm px-3 py-1.5 dark:bg-thardDark dark:text-gray-400 dark:border-gray-600 dark:hover:bg-secounderyDark dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="table-search-users" class="block mr-4 p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-full w-80 bg-primaryLight focus:ring-blue-500 focus:border-blue-500 dark:bg-thardDark dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for users" />
                        </div>
                    </div>
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-primaryDark">
                            <tr>
                        ...
                        <tbody>
                            <tr class="bg-white border-b dark:bg-thardDark dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-primaryDark">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                ...
                                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                    <img class="w-10 h-10 rounded-full" src={Img1} alt="Jese image" />
                                    <div class="pl-3">
                            ...
                            <tr class="bg-white border-b dark:bg-thardDark dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-primaryDark">
                                ...
                                <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <img class="w-10 h-10 rounded-full" src={Img2} alt="Jese image" />
                                    <div class="pl-3">
                            ...
                            <tr class="bg-white border-b dark:bg-thardDark dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-primaryDark">
                                ...
                                <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <img class="w-10 h-10 rounded-full" src={Img3} alt="Jese image" />
                                    <div class="pl-3">
                            ...
                            <tr class="bg-white border-b dark:bg-thardDark dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-primaryDark">
                                ...
                                <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <img class="w-10 h-10 rounded-full" src={Img4} alt="Jese image" />
                                    <div class="pl-3">
                            ...
                            <tr class="bg-white dark:bg-thardDark hover:bg-gray-50 dark:hover:bg-primaryDark">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                ...
                                <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <img class="w-10 h-10 rounded-full" src={Img5} alt="Jese image" />
                                    <div class="pl-3">
