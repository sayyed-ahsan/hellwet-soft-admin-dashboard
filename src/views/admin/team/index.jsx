...
const index = () => {
    return (
        <div>
            <Glass>
                <section className="py-2 bg-primaryLight dark:bg-primaryDark rounded-2xl dark:text-gray-100">
            ...
            {/* ------------- */}
            <Glass extra={'my-5'}>
                <section className="py-6 bg-primaryLight dark:bg-primaryDark rounded-2xl dark:text-gray-100">
                    <div className="container p-4 mx-auto space-y-16 sm:p-10">
                        <div className="space-y-4">
                            <h3 className="text-2xl font-bold leading-none sm:text-5xl">Meet our Customers</h3>
